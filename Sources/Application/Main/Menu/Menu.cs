                            ...
                            case 0:
                                {
                                    ...
                                    character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, String.Format("Bạn đã nhận được {0} ngọc", diamond)));
                                    break;
                                }
                            //Nhận Vàng
                            case 1:
                                {
                                    ...
                                    character.CharacterHandler.SendMessage(Service.MeLoadInfo(character));
                                    character.Delay.GetGem = timeServer + 2000;
                                    character.CharacterHandler.SendMessage(Service.OpenUiSay(npcId, String.Format("Bạn đã nhận được {0} vàng", gold)));
                                    break;
                                }
                            //Nhận đệ tử
                            case 2:
                                {
                                    ...
                                    if (character.InfoChar.IsHavePet == false && DiscipleDB.IsAlreadyExist(-character.Id))
                                    {
